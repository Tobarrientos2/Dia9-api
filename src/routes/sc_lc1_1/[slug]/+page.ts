...
export const load: PageLoad = ({ params, url }) => {
  ...
  const sc_lc1_1Random = obtenerObjetosAleatorios(sc_lc1_1, 3);
  ...
  let partes = sc_lc1_1Item_slug.split('/');
  ...
  const sc_lc1_1Item = sc_lc1_1.find((item) => item.sc_slug === sc_lc1_1Item_slug);


  let sc_dt = sc_lc1_1Item?.sc_dt || [];
  ...
  return {
    ...
    sc_lc1_1Random: sc_lc1_1Random,
    sc_lc1_1Item: {
      sc_1: sc_lc1_1Item.sc_1,
      sc_img: sc_lc1_1Item.sc_img,
      sc_2: sc_lc1_1Item.sc_2,
      sc_3: sc_lc1_1Item.sc_3,
      sc_dt1: sc_dt1,
      sc_dt2: sc_dt2,
      sc_dt: sc_dt
    },
